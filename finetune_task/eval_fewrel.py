...
from transformers.models.deberta import DebertaTokenizer, DebertaForSequenceClassification
...
def convert_examples_to_features(examples, label_list, max_seq_length, tokenizer, threshold):
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        if example.text_b:
            ...
            _truncate_seq_pair(tokens_a, tokens_b, None, None, max_seq_length - 3)
        else:
...
def main():
    ...
    if args.model_bin is None:
        file_mark = [['pytorch_model.bin_2500', True]]
    else:
        file_mark = [['pytorch_model.bin_{}'.format(args.model_bin), True]]
    print('file_mark=', file_mark)
    ...
    for x, mark in file_mark:
        ...
        if args.model_type == "roberta":
            ...
            model = DebertaForSequenceClassification.from_pretrained(args.model_name_or_path,
                                                                     state_dict=model_state_dict,
                                                                     num_labels=len(label_list))
...
if __name__ == "__main__":
    main()
'''
CUDA_VISIBLE_DEVICES=0,2 python3 eval_fewrel.py   --do_eval   --do_lower_case   --data_dir data/fewrel/   --model_name_or_path ../output/roberta-base/checkpoint-87000/   --max_seq_length 256   --train_batch_size 32   --learning_rate 2e-5   --num_train_epochs 10   --output_dir output_fewrel   --fp16   --loss_scale 128
CUDA_VISIBLE_DEVICES=6 python3 eval_fewrel.py --do_eval --do_lower_case --data_dir data/fewrel/   --model_name_or_path ../output/roberta-base-temp2/checkpoint-40000/   --max_seq_length 256   --train_batch_size 32   --learning_rate 2e-5   --num_train_epochs 10   --output_dir output_fewrel   --fp16   --loss_scale 128  --model_bin 4000

deberta
CUDA_VISIBLE_DEVICES=6 python3 eval_fewrel.py --do_eval --do_lower_case --data_dir data/fewrel/   --model_name_or_path ../output/deberta-base-temp/checkpoint-8000/ --model_type deberta   --max_seq_length 256   --train_batch_size 32   --learning_rate 2e-5   --num_train_epochs 10   --output_dir output_fewrel   --fp16   --loss_scale 128  --model_bin 4000
