...
model_path = "../../output/deberta-base-temp/checkpoint-8000"
# model_path = "/wjn/nlp_trainer/output_lama/roberta-base-lama/checkpoint-200"
# model_path = "/wjn/pre-trained-lm/deberta-base"
...
'''
CUDA_VISIBLE_DEVICES=7 nohup python3 eval_lama_deberta.py >> log10.log &
'''