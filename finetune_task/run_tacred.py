...
if __name__ == "__main__":
    main()
'''
CUDA_VISIBLE_DEVICES=6,7 nohup python3 run_tacred.py --do_train --do_lower_case --data_dir data/tacred --model_name_or_path ../output/roberta-base/checkpoint-32000/ --max_seq_length 256 --train_batch_size 32 --learning_rate 2e-5 --num_train_epochs 4.0 --output_dir output_tacred --loss_scale 128 --threshold 0.4 >> log/log_220402_3.log &
CUDA_VISIBLE_DEVICES=3 nohup python3 run_tacred.py --do_train --do_lower_case --data_dir data/tacred --model_name_or_path ../output_200w/roberta-base/checkpoint-74000/ --max_seq_length 256 --train_batch_size 32 --learning_rate 2e-5 --num_train_epochs 5.0 --output_dir output_tacred_roberta_200w --loss_scale 128 --threshold 0.4  >> log/log_220402_9.log &
CUDA_VISIBLE_DEVICES=4,5 nohup python3 run_tacred.py --do_train --do_lower_case --data_dir data/tacred --model_name_or_path roberta-base --max_seq_length 256 --train_batch_size 32 --learning_rate 2e-5 --num_train_epochs 4.0 --output_dir output_tacred_roberta2 --loss_scale 128 --threshold 0.4  >> log/log_220402_10.log &
CUDA_VISIBLE_DEVICES=5 nohup python3 run_tacred.py --do_train --do_lower_case --data_dir data/tacred --model_name_or_path ../output/roberta-base-temp/checkpoint-12000/ --max_seq_length 256 --train_batch_size 32 --learning_rate 2e-5 --num_train_epochs 20.0 --output_dir output_tacred_12000 --loss_scale 128 --threshold 0.4 >> log/log_220402_6.log &
CUDA_VISIBLE_DEVICES=6 nohup python3 run_tacred.py --do_train --do_lower_case --data_dir data/tacred --model_name_or_path ../output/roberta-base-temp/checkpoint-24000/ --max_seq_length 256 --train_batch_size 32 --learning_rate 2e-5 --num_train_epochs 20.0 --output_dir output_tacred_24000 --loss_scale 128 --threshold 0.4 >> log/log_220402_7.log &
CUDA_VISIBLE_DEVICES=6,7 nohup python3 run_tacred.py --do_train --do_lower_case --data_dir data/tacred --model_name_or_path ../output/roberta-base-temp2/checkpoint-12000/ --max_seq_length 256 --train_batch_size 32 --learning_rate 2e-5 --num_train_epochs 4.0 --output_dir output_tacred_12000 --loss_scale 128 --threshold 0.4 >> log/log_220412_3.log &
CUDA_VISIBLE_DEVICES=6,7 nohup python3 run_tacred.py --do_train --do_lower_case --data_dir data/tacred --model_name_or_path ./tacred_32000/ --max_seq_length 256 --train_batch_size 32 --learning_rate 2e-5 --num_train_epochs 4.0 --output_dir output_tacred_32000_2 --loss_scale 128 --threshold 0.4 >> log/log_220402_9.log &
'''